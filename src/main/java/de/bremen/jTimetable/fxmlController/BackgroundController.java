...
public class BackgroundController implements Initializable {
     ...
     * ToDo
     * 
     * @param selectedItem the coursePassLecturerSubject items will be set for this
     *                     coursePass that was selected in the
     *                     tableView
     */
    ...
    private void openStudySectionFXML() {
        try {
            ...
            FXMLLoader childLoader = new FXMLLoader(
                    getClass().getResource("/de/bremen/jTimetable/fxml/StudySection.fxml"),
                    this.resourceBundle);
            Pane childNode = childLoader.load();
            // Add include
            this.childContainer.getChildren().clear();
    ...
    private void openCoursePassFXML() {
        try {
            // Load fmxl that will be included in center of brdrPnAll
            FXMLLoader childLoader = new FXMLLoader(
                    getClass().getResource("/de/bremen/jTimetable/fxml/Coursepass.fxml"),
                    this.resourceBundle);
            Pane childNode = childLoader.load();
            // Add include
            this.childContainer.getChildren().clear();
    ...
    private void openCoursePassLecturerSubjectFXML() {
        try {
            // Load fmxl that will be included in center of brdrPnAll
            FXMLLoader childLoader = new FXMLLoader(
                    getClass().getResource("/de/bremen/jTimetable/fxml/CoursepassLecturerSubject.fxml"),
                    this.resourceBundle);
            Pane childNode = childLoader.load();
            // Add include
            this.childContainer.getChildren().clear();
    ...
    private void openCourseOfStudyFXML() {
        try {
            // Load fmxl that will be included in center of brdrPnAll
            FXMLLoader childLoader = new FXMLLoader(
                    getClass().getResource("/de/bremen/jTimetable/fxml/CourseofStudy.fxml"), this.resourceBundle);
            Pane childNode = childLoader.load();
            // Add include
            this.childContainer.getChildren().clear();
            this.childContainer.getChildren().add(childNode);
    ...
    private void openSubjectFXML() {
        try {
            ...
            // Do something with the child node and controller
            Scene scene = this.brdrPnAll.getScene();
            subjectController.addTopmenuButtons(scene);
    ...
    private void openRoomFXML() {
        try {
            ...
            // Do something with the child node and controller
            Scene scene = this.brdrPnAll.getScene();
            roomController.addTopmenuButtons(scene);
        } catch (IOException e) {
            System.err.println("Lecturer could not be loaded properly!");
        }
    }

    private void openLocationFXML() {
        try {
            // Load fmxl that will be included in center of brdrPnAll
            ...
            // Do something with the child node and controller
            Scene scene = this.brdrPnAll.getScene();
            locationController.addTopmenuButtons(scene);
        } catch (IOException e) {
